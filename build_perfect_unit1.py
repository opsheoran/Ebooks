...
def generate_mcqs():
    ...
    for i, (q, opts, ans_idx) in enumerate(q_data, 1):
        ...
        <div class="question">
            <strong>Q{i}.</strong> {q}
            <div class="mcq-options"><p>{opt_html}</p></div>
        </div>
        ...
        <div class="question">
            ...
            <div class="mcq-options"><p>{opt_html_hi}</p></div>
        </div>
        <button class="toggle-btn" onclick="toggleAnswer('mcq-hin-{i}')">Show Answer ▼</button>
        <div class="answer" id="mcq-hin-{i}"><strong>Answer:</strong> {ans_text_hi}</div>
        '''
...
print("Extracting and formatting sections...")
sections_html = ""
...
print("Stat-101/Unit-I.html fully updated with translated exercises and correct verbatim routing!")
