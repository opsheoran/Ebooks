...
# Dictionary to revert pure Hindi terms back to English for "True Hinglish"
hinglish_dict = {
    r'\bसांख्यिकी\b': 'Statistics',
    r'\bसांख्यिकीय\b': 'statistical',
    r'\bडेटा\b': 'data',
    r'\bआंकड़े\b': 'data',
    r'\bआंकड़ों\b': 'data',
    r'\bप्रतिदर्श\b': 'sample',
    r'\bनमूना\b': 'sample',
    r'\bनमूने\b': 'samples',
    r'\bजनसंख्या\b': 'population',
    r'\bआबादी\b': 'population',
    r'\bचर\b': 'variable',
    r'\bगुणात्मक\b': 'qualitative',
    r'\bमात्रात्मक\b': 'quantitative',
    r'\bऔसत\b': 'average',
    r'\bमाध्य\b': 'mean',
    r'\bमाध्यिका\b': 'median',
    r'\bबहुलक\b': 'mode',
    r'\bमानक विचलन\b': 'standard deviation',
    r'\bप्रसरण\b': 'variance',
    r'\bप्रायिकता\b': 'probability',
    r'\bवितरण\b': 'distribution',
    r'\bपरिकल्पना परीक्षण\b': 'hypothesis testing',
    r'\bपरिकल्पना\b': 'hypothesis',
    r'\bपरीक्षण\b': 'testing',
    r'\bप्रतिगमन\b': 'regression',
    r'\bसहसंबंध\b': 'correlation',
    r'\bवर्गीकरण\b': 'classification',
    r'\bसारणीकरण\b': 'tabulation',
    r'\bअवलोकन\b': 'observation',
    r'\bप्रश्नावली\b': 'questionnaire',
    r'\bसाक्षात्कार\b': 'interview',
    r'\bप्राथमिक\b': 'primary',
    r'\bद्वितीयक\b': 'secondary',
    r'\bविश्लेषणात्मक\b': 'analytical',
    r'\bविश्लेषण\b': 'analysis',
    r'\bवर्णनात्मक\b': 'descriptive',
    r'\bअनुमानात्मक\b': 'inferential',
    r'\bअनुमान\b': 'estimation',
    r'\bप्रतिचयन\b': 'sampling',
    r'\bस्तरीकृत\b': 'stratified',
    r'\bयादृच्छिक\b': 'random',
    r'\bगुच्छ\b': 'cluster',
    r'\bव्यवस्थित\b': 'systematic',
    r'\bसर्वेक्षण\b': 'survey',
    r'\bसर्वेक्षणों\b': 'surveys',
    r'\bग्राफ\b': 'graph',
    r'\bचार्ट\b': 'chart',
    r'\bपाई चार्ट\b': 'pie chart',
    r'\bबार चार्ट\b': 'bar chart',
    r'\bहिस्टोग्राम\b': 'histogram',
    r'\bस्कैटर प्लॉट\b': 'scatter plot',
    r'\bकेंद्रीय प्रवृत्ति\b': 'central tendency',
    r'\bप्रकीर्णन\b': 'dispersion',
    r'\bविषमता\b': 'skewness',
    r'\bकुकुदता\b': 'kurtosis',
    r'\bसंकेतन\b': 'notation',
    r'\bद्विभाजन\b': 'dichotomy',
    r'\bआवृत्तियां\b': 'frequencies',
    r'\bआवृत्ति\b': 'frequency',
    r'\bगुण\b': 'attribute',
    r'\bविशेषताओं\b': 'attributes',
    r'\bस्वतंत्रता\b': 'independence',
    r'\bसंगति\b': 'consistency',
    r'\bगुणांक\b': 'coefficient',
    r'\bसंबंध\b': 'association',
    r'\bसंभाव्यता\b': 'probability',
    r'\bविज्ञान\b': 'science',
    r'\bगणितीय\b': 'mathematical',
    r'\bगणित\b': 'mathematics',
    r'\bप्रक्रियाओं\b': 'procedures',
    r'\bप्रक्रिया\b': 'process',
    r'\bशोधकर्ता\b': 'researcher',
    r'\bशोध\b': 'research',
    r'\bत्रुटि\b': 'error',
    r'\bत्रुटियों\b': 'errors',
    r'\bसटीकता\b': 'accuracy',
    r'\bपरिणाम\b': 'result',
    r'\bपरिणामों\b': 'results',
    r'\bनिर्णय\b': 'decision',
    r'\bनिष्कर्ष\b': 'conclusion',
    r'\bतकनीकों\b': 'techniques',
    r'\bतकनीक\b': 'technique',
    r'\bविधियां\b': 'methods',
    r'\bविधि\b': 'method',
    r'\bसॉफ्टवेयर\b': 'software',
    r'\bइंटरैक्टिव\b': 'interactive',
    r'\bडिज़ाइन\b': 'design',
    r'\bमॉडल\b': 'model',
    r'\bमापन\b': 'measurement',
    r'\bमूल्यांकन\b': 'evaluation',
    r'\bसमीक्षा\b': 'review',
    r'\bअध्याय\b': 'chapter',
    r'\bतथ्य\b': 'facts',
    r'\bतथ्यों\b': 'facts',
    r'\bजानकारी\b': 'information',
    r'\bसमस्या\b': 'problem',
    r'\bसमस्याओं\b': 'problems',
    r'\bसमाधान\b': 'solution',
    r'\bउदाहरण\b': 'example',
    r'\bअनुप्रयोग\b': 'application',
    r'\bमूल्य\b': 'value',
    r'\bमूल्यों\b': 'values',
    r'\bचरों\b': 'variables',
    r'\bस्तर\b': 'level',
    r'\bउपज\b': 'yield',
    r'\bक्षेत्र\b': 'field',
    r'\bप्रभावी\b': 'effective',
    r'\bप्रतिस्थापन\b': 'replacement',
    r'\bआकार\b': 'size',
    r'\bजटिल\b': 'complex',
    r'\bसिद्धांत\b': 'theory',
    r'\bसैद्धांतिक\b': 'theoretical',
    r'\bप्रदान\b': 'provide'
}
...
def to_hinglish(text):
    ...
    try:
        ...
        # Apply the reverse dictionary for True Hinglish
        for hindi_term, eng_term in hinglish_dict.items():
            translated = re.sub(hindi_term, eng_term, translated, flags=re.IGNORECASE)
...
print("Reading verbatim theory...")
with open('Stat-101/Chapter1.html', 'r', encoding='utf-8') as f:
    soup = BeautifulSoup(f.read(), 'html.parser')

print("Extracting and formatting sections with True Hinglish...")
sections_html = ""
for section in soup.find_all('div', class_='section'):
    sec_id = section.get('id')
    if sec_id and 'exercises' in sec_id.lower():
        continue
        
    sec_content = "".join([str(child) for child in section.children])
    sec_content = re.sub(r'Hello students,\s*welcome to the BSc First Year\s*Statistics\s*course\.', '', sec_content, flags=re.IGNORECASE)
    
    sec_soup = BeautifulSoup(sec_content, 'html.parser')
    for head in sec_soup.find_all('div', class_='head'):
        ...
        if num and title:
            ...
            new_tag = sec_soup.new_tag(tag_name)
            new_tag.string = f"{num_text} {title_text}"
            head.replace_with(new_tag)
            
    eng_html = str(sec_soup)
    print(f"Translating section: {sec_id}")
    hin_html = translate_html_block(eng_html)
    
    sections_html += f'''
        <div class="topic-section" id="{sec_id}">
            <section class="section-card">
                <div class="english-content">{eng_html}</div>
                <div class="hinglish-content" style="display:none;">{hin_html}</div>
            </section>
        </div>
    '''
...
final_html = html_template.replace('{VERBATIM_PLACEHOLDER}', sections_html).replace('{EXERCISES_PLACEHOLDER}', exercises_html)

print("Writing final file...")
with open('Stat-101/Unit-I.html', 'w', encoding='utf-8') as f:
    f.write(final_html)

print("Stat-101/Unit-I.html fully updated with True Hinglish translation!")
