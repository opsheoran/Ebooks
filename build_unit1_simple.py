...
<head>
    ...
    <style>
        /* Specific override for the toggle button in the header card */
        .chapter-header {
            position: relative;
        }
        .header-lang-toggle {
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav-list">
            <li class="nav-item">
                <a class="nav-link" href="index.html" style="background: rgba(200,146,42,0.1); color: var(--gold-light); font-weight: 600;">
                    <span class="nav-num">🏠</span> Course Home
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="nav-list">
            <li class="nav-item"><a class="nav-link" href="#" onclick="showTopic('exercises');return false;"><span class="nav-num">📝</span> Exercises</a></li>
        </ul>
    </nav>

    <main class="main-content">
        <div class="chapter-header">
            <!-- LANGUAGE TOGGLE BUTTON PLACED IN THE HEADER CARD TOP RIGHT -->
        ...
        <!-- SECTION 1.6: AREAS OF APPLICATION (EXPANDED WITH EXAMPLES) -->
            ...
            <section class="section-card">
                <div class="english-content">
                    ...
                    <div class="highlight-box">
                        <p><strong>1. In Agriculture (Farming)</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>2. In Healthcare and Medicine</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>3. In Business and Marketing</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>4. In Government Planning</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>5. In Sports</strong></p>
                        <p>Teams use statistics to win games and choose the best players. <br>
                        <em>Example:</em> In cricket, a team manager looks at the strike rate, batting average, and bowling economy of all players. They use these numbers to select the perfect playing 11 for the World Cup match.</p>
                    </div>
                </div>
                <div class="hinglish-content" style="display:none;">
                    ...
                    <div class="highlight-box">
                        <p><strong>1. In Agriculture (कृषि/खेती में)</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>2. In Healthcare and Medicine (स्वास्थ्य सेवा और चिकित्सा में)</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>3. In Business and Marketing (व्यवसाय और मार्केटिंग में)</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>4. In Government Planning (सरकारी योजना में)</strong></p>
                    ...
                    <div class="highlight-box">
                        <p><strong>5. In Sports (खेलों में)</strong></p>
                        <p>टीमें गेम जीतने और सर्वश्रेष्ठ खिलाड़ियों को चुनने के लिए statistics का उपयोग करती हैं। <br>
                        <em>उदाहरण:</em> क्रिकेट में, टीम मैनेजर सभी खिलाड़ियों के strike rate, batting average और bowling economy को देखता है। वे विश्व कप मैच के लिए perfect playing 11 चुनने के लिए इन नंबरों का उपयोग करते हैं।</p>
                    </div>
                </div>
            </section>
        </div>
        ...
        <!-- EXERCISES -->
        <div id="exercises" class="topic-section">
            <section class="section-card">
                <h2><span class="section-num">📝</span> Exercises</h2>
                <div class="english-content">
                    <p>Test your knowledge with the following interactive exercises. Try to answer them yourself before checking the solutions.</p>
                </div>
                <div class="hinglish-content" style="display:none;">
                    <p>निम्नलिखित interactive exercises के साथ अपने ज्ञान का परीक्षण करें। समाधान (solutions) देखने से पहले स्वयं उत्तर देने का प्रयास करें।</p>
                </div>
...
print("Stat-101/Unit-I.html generated successfully with simplified text and top-right toggle.")
