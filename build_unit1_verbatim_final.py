...
# Read the extracted theory html
with open('extracted_theory.html', 'r', encoding='utf-8') as f:
    theory_html = f.read()
...
print("Stat-101/Unit-I.html generated successfully with correct CSS and verbatim blocks.")
