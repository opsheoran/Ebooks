...
# Removed \b because it doesn't work well with Devanagari characters
hinglish_dict = {
...
def to_hinglish(text):
    ...
    try:
        ...
        for hindi_term in sorted_keys:
            ...
            # Simple string replace works fine for Devanagari text
            translated = translated.replace(hindi_term, eng_term)
            
        # Fix grammar spacing issues around English words
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav-list">
            <li class="nav-item"><a class="nav-link active" href="#introduction" onclick="showTopic('introduction');return false;"><span class="nav-num">1.1</span> Introduction</a></li>
            <li class="nav-item"><a class="nav-link" href="#historical-development" onclick="showTopic('historical-development');return false;"><span class="nav-num">1.2</span> Historical Development</a></li>
            <li class="nav-item"><a class="nav-link" href="#what-is-statistics" onclick="showTopic('what-is-statistics');return false;"><span class="nav-num">1.3</span> What is Statistics?</a></li>
            <li class="nav-item"><a class="nav-link" href="#scope-of-statistics" onclick="showTopic('scope-of-statistics');return false;"><span class="nav-num">1.4</span> Scope of Statistics</a></li>
            <li class="nav-item"><a class="nav-link" href="#advantages-of-statistics" onclick="showTopic('advantages-of-statistics');return false;"><span class="nav-num">1.5</span> Advantages of Statistics</a></li>
            <li class="nav-item"><a class="nav-link" href="#limitations-of-statistics" onclick="showTopic('limitations-of-statistics');return false;"><span class="nav-num">1.6</span> Limitations of Statistics</a></li>
            <li class="nav-item"><a class="nav-link" href="#areas-of-application" onclick="showTopic('areas-of-application');return false;"><span class="nav-num">1.7</span> Areas of Application</a></li>
            <li class="nav-item"><a class="nav-link" href="#conclusion" onclick="showTopic('conclusion');return false;"><span class="nav-num">1.8</span> Conclusion</a></li>
        </ul>
    ...
    <script>
        // Ensure ONLY the selected section is active to prevent blank screens
        document.addEventListener('DOMContentLoaded', () => {
            const hash = window.location.hash.substring(1);
            if (hash && document.getElementById(hash)) {
                showTopic(hash);
            } else {
                showTopic('introduction');
            }
        });
        ...
        function showTopic(id) {
            ...
            // Fixed the active link selector to avoid crashes
            ...
            // update history state without jumping
...
for section in soup.find_all('div', class_='section'):
    ...
    # Hide all sections by default except the first one (will be handled by JS)
    sections_html += f'''
...
print("Stat-101/Unit-I.html fully updated with safe JS routing and True Hinglish translation!")
